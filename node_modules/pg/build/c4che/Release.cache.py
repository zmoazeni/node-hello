...
CPPPATH_PG = ['/usr/local/Cellar/postgresql/9.2.1/include']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/zmoazeni/.node_libraries'
LIBPATH_NODE = '/usr/local/Cellar/node/0.8.4/lib'
LIBPATH_PG = ['/usr/local/Cellar/postgresql/9.2.1/lib']
LIBPATH_ST = '-L%s'
LIB_PG = ['pq']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/zmoazeni/.node_libraries'
